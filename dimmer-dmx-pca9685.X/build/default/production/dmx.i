...
__attribute__((inline)) void resetDataWatchdog(void);
extern void decrementDataWatchdog(void);

__attribute__((inline)) void resetSignalWatchdog(void);
...
void initDMX() {
    ...
    topAddress = baseAddress + 32U; // To save some cycles in the irq
...
__attribute__((inline)) void resetSignalWatchdog() {
